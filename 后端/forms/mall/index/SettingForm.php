    ...
    public function rules()
    {
        return [
            ...
            [['contact_tel', 'kdniao_mch_id', 'kdniao_api_key', 'member_integral_rule',
                ...
                'kdniao_select_type', 'kd100_yum'], 'string'],
            [['over_time', 'delivery_time', 'after_sale_time', 'member_integral',
                ...
                'is_show_hot_goods', 'is_open','open_type','is_auto_open', 'has_order_evaluate', 'order_evaluate_day', 'is_verify_mobile'], 'integer'],
            [['name'], 'required',],
            ...
            [['good_negotiable', 'payment_type', 'send_type', 'business_time_type_day', 'business_time_type_week',
                'auto_business_time', 'quick_customize_params', 'quick_customize_new_params', 'send_type_desc', 'time_list', 'week_list', 'customer_service_list'], 'safe'],
    ...
    public function save()
    {
        ...
        try {
            ...
            foreach ($this->attributes as $k => $item) {
                ...
                if (in_array($k, ['good_negotiable', 'payment_type', 'send_type', 'business_time_type_week', 'business_time_type_day', 'quick_customize_new_params', 'send_type_desc', 'week_list', 'time_list', 'customer_service_list'])) {
