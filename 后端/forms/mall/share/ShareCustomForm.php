...
//        $default = $this->getBonus($default);
    ...
    private function getDefaultData()
    {
        if (isset(\Yii::$app->request->hostInfo)) {
            $iconUrlPrefix = \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/img/';
        } else {
            $iconUrlPrefix = '';
        }
        return [
            'menus' => [
                'money' => [
                    'name' => '分销佣金',
                    'icon' => $iconUrlPrefix . 'mall/share-custom/img-share-price.png',
                    'open_type' => 'navigator',
                ...
                'order' => [
                    'name' => '分销订单',
                    'icon' => $iconUrlPrefix . 'mall/share-custom/img-share-order.png',
                    'open_type' => 'navigator',
                ...
                'cash' => [
                    'name' => '提现明细',
                    'icon' => $iconUrlPrefix . 'mall/share-custom/img-share-cash.png',
                    'open_type' => 'navigator',
                ...
                'team' => [
                    'name' => '我的团队',
                    'icon' => $iconUrlPrefix . 'mall/share-custom/img-share-team.png',
                    'open_type' => 'navigator',
                ...
                'qrcode' => [
                    'name' => '推广二维码',
                    'icon' => $iconUrlPrefix . 'mall/share-custom/img-share-qrcode.png',
                    'open_type' => 'navigator',
            ...
            'apply' => [
                ...
                'apply_btn_round' => 40,
                'apply_head_pic' => $iconUrlPrefix . 'app/share/img-share-apply.png',
                'apply_end_pic' => $iconUrlPrefix . 'app/share/apply-end-pic.png',
            ]
        ];
    }
