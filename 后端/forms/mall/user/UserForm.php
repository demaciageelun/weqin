...
class UserForm extends Model
{
    ...
    public function shareUser()
    {
        ...
        try {
            ...
            array_unshift($list, ['id' => 0, 'new_name' => $parentName]);
            return [
    ...
    public function getList()
    {
        ...
        if ($this->flag == "EXPORT") {
            $queueId = CommonExport::handle([
                ...
                'second' => CommonExport::getSecond($query->count())
            ]);
    ...
    public function getDetail()
    {
        ...
        $newList = [
            ...
            'new_name' => $user->parent ? "(".$user->parent->id.")" . $user->parent->nickname : $parentName,
