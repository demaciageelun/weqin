...
class ActivityEditForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['start_at', 'end_at', 'app_share_title', 'app_share_pic'], 'string'],
            ...
            [['app_share_title', 'app_share_pic'], 'default', 'value' => ''],
        ];
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            $fullReduceActivity->app_share_title = $this->app_share_title;
            $fullReduceActivity->app_share_pic = $this->app_share_pic;
