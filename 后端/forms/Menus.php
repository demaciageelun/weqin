...
//                    [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'children' => [
                            // [
                            //     'name' => '挂件设置',
                            //     'route' => 'mall/live/pendant-setting',
                            // ],
                            // [
                            //     'key' => 'live',
                            //     'name' => '挂件商品',
                            //     'route' => 'mall/live/pendant-goods',
                            //     'action' => [
                            //         [
                            //             'name' => '挂件商品编辑',
                            //             'route' => 'mall/live/pendant-goods',
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => '订单设置',
                        'route' => 'mall/index/order-setting',
                    ],
                    [
                        'name' => '支付管理',
                        'route' => '',
        ...
        return [
            [
                ...
                'children' => [
                    ...
                    [
                        'key' => 'user_group', // 超级管理员 显示
                        'name' => '用户组',
                        'route' => 'admin/user/user-group',
                        'icon' => 'icon-liebiao',
                        'action' => [
                            [
                                'key' => 'user_group_edit', // 超级管理员 显示
                                'name' => '用户组编辑',
                                'route' => 'admin/user/user-group-edit',
                                'icon' => 'icon-add1',
                            ],
                        ]
                    ],
                    [
                        'key' => 'permissions_group', // 超级管理员 显示
                        'name' => '权限套餐组',
                        'route' => 'admin/user/permissions-group',
                        'icon' => 'icon-liebiao',
                        'action' => [
                            [
                                'key' => 'permissions_group_edit', // 超级管理员 显示
                                'name' => '权限套餐组编辑',
                                'route' => 'admin/user/permissions-group-edit',
                                'icon' => 'icon-add1',
                            ],
                        ]
                    ],
