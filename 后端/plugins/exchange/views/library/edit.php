...
<div id="app" v-cloak>
            ...
            <el-card v-if="id == 0">
                ...
                <el-form-item>
                    ...
                    <div flex="dir:left cross:center" v-if="form.is_limit == 1" style="padding-top: 10px;">
                        <el-radio v-model="form.limit_user_type" label="day">每位用户每天限制兑换成功</el-radio>
                        <div>
                ...
                <el-form-item label="奖励品">
                    <div flex="dir:left">
                        <el-button v-if="form.rewards.length < 20" class="height-button"
                                   @click="chooseDialog=true;chooseType='goods'">添加奖励品
                        </el-button>
                        ...
                        <el-table-column label="名称">
                            <template slot-scope="props">
                                ...
                                <div v-if="props.row.type == 'svip'">
                                    ...
                                    <div>折扣：<span style="color: #ff4544">{{svip.discount == 0 ? '免费': svip.discount + '折'}}</span></div>
        ...
        <div class="dialog-choose-radio" v-else-if="chooseType == 'svip'">
            <el-table v-loading="listLoading" border :data="list" style="width: 100%">
                ...
                <el-table-column label="折扣">
                    <template slot-scope="scope">
                        <div>{{svip.discount == 0 ? '免费': svip.discount + '折'}}</div>
                    </template>
                </el-table-column>
    ...
    <el-dialog :title="!exchangeVisible ? '查看兑换规则':'兑换详情'" :visible.sync="dialogVisible" width="960px">
        ...
        <el-form v-loading="dialogLoading" @submit.native.prevent size="small" ref="form" label-width="130px">
            ...
            <el-form-item v-if="!exchangeVisible && form.is_limit == 1" label="兑换次数限制" prop="is_limit">
                <div v-if="form.limit_user_type == 'day'">每位用户每天限制兑换{{form.limit_user_num}}次</div>
                <div v-if="form.limit_user_type == 'all'">每位用户永久兑换{{form.limit_user_success_num}}次</div>
            </el-form-item>
    ...
    <el-dialog :title="getActivityCode ? '生成动态活码':'查看二维码'" :visible.sync="qrVisible" width="30%">
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            download() {
                ...
                alink.download = !this.getActivityCode ? '二维码-' + this.qrDetail.code : '动态活码';
                alink.click();
