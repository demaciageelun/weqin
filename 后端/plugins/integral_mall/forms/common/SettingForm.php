...
class SettingForm extends Model
{
    ...
    public function search()
    {
        ...
        if ($setting) {
            ...
            $customize = isset($setting['customize'])
                ? json_decode($setting['customize'], true)
                : $default['customize'];
            $setting['customize'] = $customize ?: CommonOption::getCustomizeDefault();
    ...
    private function getDefault()
    {
        return [
            ...
            'customize' => CommonOption::getCustomizeDefault(),
