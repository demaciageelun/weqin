...
class GoodsEditForm extends BaseGoodsEdit
{
    ...
    public $limit_status;
    public $limit_i_status;
    public $limit_i_type;
    public $limit_i_num;
    public $limit_h_status;
    public $limit_h_type;
    public $limit_h_num;
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['min_price', 'bargain_time', 'bargain_first_min_price', 'bargain_first_max_price',
                'bargain_second_min_price', 'bargain_second_max_price',
                'limit_status', 'limit_h_num', 'limit_i_num'
            ], 'number', 'min' => 0, 'max' => 999999],
            [['bargain_people', 'bargain_human', 'stock', 'limit_i_num', 'limit_h_num'], 'integer', 'min' => 0, 'max' => 999999],
            [['begin_time', 'end_time', 'limit_i_status', 'limit_i_type', 'limit_h_status', 'limit_h_type'], 'string']
...
//            }]
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'begin_time' => '开始时间',
            'end_time' => '结束时间',
            'limit_status' => '限制砍价次数开关',
            'limit_i_status' => '用户可发起砍价次数开关',
            'limit_i_type' => '用户可发起砍价次数类型',
            'limit_i_num' => '用户可发起砍价次数',
            'limit_h_status' => '用户可帮砍次数开关',
            'limit_h_type' => '用户可帮砍次数类型',
            'limit_h_num' => '用户可帮砍次数',
        ]);
    }
    ...
    private function bargain()
    {
        ...
        $model->limit_data = \Yii::$app->serializer->encode([
            'limit_status' => $this->limit_status,
            'limit_i_status' => $this->limit_i_status,
            'limit_i_type' => $this->limit_i_type,
            'limit_i_num' => $this->limit_i_num,
            'limit_h_status' => $this->limit_h_status,
            'limit_h_type' => $this->limit_h_type,
            'limit_h_num' => $this->limit_h_num,
        ]);
