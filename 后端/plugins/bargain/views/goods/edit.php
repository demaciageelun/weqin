        ...
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer"
                                          @click="$navigate({r:'plugin/bargain/mall/goods/index'})">砍价活动</span>
                </el-breadcrumb-item>
            ...
            <template slot="before_goods">
                <el-card shadow="never" style="margin-top: 24px;margin-bottom: 24px;">
                    ...
                    <el-col :xl="12" :lg="16">
                                ...
                                <el-col :span="6">
                                    <el-form-item prop="bargain_first_min_price">
                                        <el-input required type="number" v-model="form.bargain_first_min_price"
                                                  @input="changeSalary('bargain_first_min_price')">
                                ...
                                <el-col :span="6">
                                    <el-form-item prop="bargain_first_max_price">
                                        <el-input required type="number" v-model="form.bargain_first_max_price"
                                                  @input="changeSalary('bargain_first_max_price')">
                                            <template slot="append">元</template>
                                        </el-input>
                                    </el-form-item>
                                </el-col>
                            ...
                            <div style="margin-top: 18px;">
                                <el-col :span="12">
                                    <el-form-item prop="bargain_second_min_price">
                                        <el-input required type="number"
                                                  @input="changeSalary('bargain_second_min_price')"
                                                  v-model="form.bargain_second_min_price">
                                ...
                                <el-col :span="12">
                                    <el-form-item prop="bargain_second_max_price">
                                        <el-input required type="number"
                                                  @input="changeSalary('bargain_second_max_price')"
                                                  v-model="form.bargain_second_max_price">
                        ...
                        <el-form-item label="限制砍价次数" width="120">
                            <el-switch v-model="form.limit_status" :active-value="1" :inactive-value="0"></el-switch>
                        </el-form-item>
                        <el-form-item label="用户可发起砍价次数" width="120" v-if="form.limit_status == 1">
                            <el-radio-group v-model.number="form.limit_i_status">
                                <el-radio label="">无限制</el-radio>
                                <el-radio label="cycle">按周期</el-radio>
                            </el-radio-group>
                            <el-input size="small" v-model="form.limit_i_num" v-if="form.limit_i_status === 'cycle'"
                                      oninput="this.value = this.value.match(/[1-9]\d{0,5}/)"
                            >
                                <el-select slot="prepend" v-model="form.limit_i_type" style="width: 80px">
                        ...
                        <el-form-item label="用户可帮砍次数" width="120" v-if="form.limit_status == 1">
                            <el-radio-group v-model.number="form.limit_h_status">
                                <el-radio label="">无限制</el-radio>
                                <el-radio label="cycle">按周期</el-radio>
                            </el-radio-group>
                            <el-input size="small" v-model="form.limit_h_num" v-if="form.limit_h_status === 'cycle'"
                                      oninput="this.value = this.value.match(/[1-9]\d{0,5}/)"
                            >
                                <el-select slot="prepend" v-model="form.limit_h_type" style="width: 80px">
                                    <el-option label="每天" value="day"></el-option>
                                    <el-option label="每周" value="week"></el-option>
                                    <el-option label="每月" value="month"></el-option>
                                    <el-option label="永久" value="all"></el-option>
                            ...
                            <div flex="dir:top" style="font-size: 10px;color:#999999">
                                <div flex="dir:left" style="margin-top:16px">
                                    <div flex="dir:left">
                                        ...
                                        <div style="color:#ff4544;font-size:18px;line-height:10px">{{form.min_price}}
                                        </div>
                                    </div>
                                    <div style="margin-left: 6px;text-decoration: line-through;">
                                        原价￥{{previewData.original_price}}
                                    </div>
                                </div>
