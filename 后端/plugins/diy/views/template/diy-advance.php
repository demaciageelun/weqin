...
<template id="diy-advance">
    <div class="diy-advance">
        <div class="diy-component-preview" :style="cListStyle">
            <app-g :data="data" :list="cList" sign="advance">
                ...
                <template slot="nameEnd" slot-scope="scope">
                    <div>
                        ...
                        <div class="des-text" style="color:red;height: auto;">
                            定金{{scope.goods.deposit}}抵{{scope.goods.swell_deposit}}
                        </div>
                    </div>
                </template>
            </app-g>
        ...
        computed: {
            ...
            cTimerStyle() {
                if (this.data.listStyle === 2) {
                    ...
                    return 'height:50px;line-height:50px;font-size:20px;text-align:center;';
                } else {
                    return '';
                }
            },
