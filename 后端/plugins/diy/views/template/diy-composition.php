    ...
    <div class="diy-composition">
        <div class="diy-component-preview" :style="cListStyle">
            <div class="goods-list" :class="'goods-list-'+data.listStyle" :flex="cListFlex"
                ...
                <div v-for="item in cList" :style="cItemStyle">
                    <div class="goods-item"
                         :flex="cGoodsFlex"
                         :class="'goods-cover-'+data.goodsCoverProportion"
                         :style="cGoodsStyle">
                        <div class="goods-pic" :class="coverPicClass(item)" :style="[styleB, picStyle]">
                            <!-- 336 -->
                            <el-image v-for="pic in item.cover_pic_list" :fit="data.fill === 1 ? 'cover': 'contain'"
                                      :src="pic" alt="">
        ...
        <div class="diy-component-edit">
            <el-form @submit.native.prevent label-width="150px">
                    ...
                    <div style="border: 1px solid #e2e2e2;border-radius:6px;padding-top: 15px">
                        <el-form-item label="上边距">
                            <div flex="dir:left">
                                ...
                                <el-input-number v-model="data.c_padding_top" :min="0"
                        ...
                        <el-form-item label="下边距">
                            <div flex="dir:left">
                                <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                           v-model="data.c_padding_bottom"
                                           :max="50" :min="0"
                                           :show-tooltip="false"></el-slider>
                                <el-input-number v-model="data.c_padding_bottom" :min="0"
                                                 :max="50" label="按钮圆角"></el-input-number>
                                <div style="margin-left: 10px">px</div>
                            </div>
                        </el-form-item>
                ...
                <el-form-item label="圆角设置">
                    <div style="border: 1px solid #e2e2e2;border-radius:6px;padding-top: 15px">
                        <el-form-item label="上圆角">
                            <div flex="dir:left">
                                <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                           v-model="data.c_border_top"
                                           :max="50" :min="0"
                                           :show-tooltip="false"></el-slider>
                                <el-input-number v-model="data.c_border_top" :min="0"
                                                 :max="50" label="按钮圆角"></el-input-number>
                                <div style="margin-left: 10px">px</div>
                            </div>
                        </el-form-item>
                        <el-form-item label="下圆角">
                            <div flex="dir:left">
                                <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                           v-model="data.c_border_bottom"
                                           :max="50" :min="0"
                                           :show-tooltip="false"></el-slider>
                                <el-input-number v-model="data.c_border_bottom" :min="0"
                                                 :max="50" label="按钮圆角"></el-input-number>
                                <div style="margin-left: 10px">px</div>
                            </div>
                        </el-form-item>
                ...
                <el-form-item label="底部背景颜色">
                    <el-color-picker @change="(row) => {row == null ? data.backgroundColor = '#F7F7F7' : ''}"
                                     size="small"
...
<script>
    Vue.component('diy-composition', {
        ...
        computed: {
            ...
            goodsListStyle() {
                return {
                    padding: `${this.data.c_padding_top}px ${this.data.c_padding_lr}px ${this.data.c_padding_bottom}px`,
                    marginRight: this.data.listStyle == 2 ? '-24px' : '0',
                    marginBottom: '-24px',
                }
            },
            cListStyle() {
                if (this.data.backgroundColor) {
                    return `padding-bottom:0.1px;background-color:${this.data.backgroundColor};background-image:url(${this.data.backgroundPicUrl});background-size:${this.data.backgroundWidth}% ${this.data.backgroundHeight}%;background-repeat:${this.repeat};background-position:${this.position}`
                } else {
                    return `padding-bottom:0.1px;background-image:url(${this.data.backgroundPicUrl});background-size:${this.data.backgroundWidth}% ${this.data.backgroundHeight}%;background-repeat:${this.repeat};background-position:${this.position}`
                }
            },
            coverPicClass() {
                return (data) => {
            ...
            cItemStyle() {
                if (this.data.listStyle === 2) {
                    return 'width: calc(50% - 24px);margin-right:24px;margin-bottom:24px';
                } else {
                    return 'width: 100%;margin-bottom: 24px';
                }
            },
            cGoodsStyle() {
                let style = `border-top-left-radius:${this.data.c_border_top}px;border-top-right-radius:${this.data.c_border_top}px;border-bottom-left-radius:${this.data.c_border_bottom}px;border-bottom-right-radius:${this.data.c_border_bottom}px;`;
                if (this.data.goodsStyle == 1 || this.data.goodsStyle == 2) {
                    style += 'backgroundColor: white;';
                } else {
                    style += `backgroundColor:${this.data.bg};`;
                }
            ...
            cGoodsInfoStyle() {
                let style = 'position:relative;border-radius:0 0 ' + `${this.data.c_border_bottom}px ${this.data.c_border_bottom}px;`;
                if (this.data.listStyle !== -1) {
                    style += 'padding:20px;';
                } else {
