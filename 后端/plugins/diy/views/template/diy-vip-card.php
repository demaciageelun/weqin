...
<template id="diy-vip-card">
    <div class="diy-vip-card">
        <div v-loading="!data" class="diy-component-preview">
            <div class="diy-buy-user-info" :style="styleA">
                <div>
                    <img class="buy-bg" :src="buy_bg" alt="" :style="styleB">
                        ...
                        <el-form-item class="diy-user-label" label="未购买用户" prop="buy_user">
                            <el-form-item label="背景图" prop="buy_bg">
                                <div style="position: relative">
                                    ...
                                    <div style="margin: 10px 0;position: relative;width: 80px;">
                                        ...
                                        <el-button v-if="buy_bg != ''" class="diy-del-btn" @click="resetImg(1,'buy')"
                                                   size="mini" type="danger" icon="el-icon-close" circle></el-button>
                                    </div>
                                    <el-button size="mini" @click="resetImg(2,'buy')" class="diy-reset" type="primary">
                                        恢复默认
                                    </el-button>
                                </div>
                            </el-form-item>
                            <el-form-item label="文字" prop="buy_text">
                                <div flex="dir:left cross:center">
                                    <el-input maxlength="15" style="margin-left: 10px;width: 240px" size="small"
                                              v-model="data.buy_big" placeholder="大标题（字符限制15）"></el-input>
                                    <el-color-picker class="diy-color-picker" size="small"
                                                     v-model="data.buy_big_color"></el-color-picker>
                                    <el-input size="small" style="width: 80px;margin-right: 25px;"
                                              v-model="data.buy_big_color"></el-input>
                                </div>
                                <div flex="dir:left cross:center">
                                    ...
                                    <el-color-picker class="diy-color-picker" size="small"
                                                     v-model="data.buy_small_color"></el-color-picker>
                                    <el-input size="small" style="width: 80px;margin-right: 25px;"
                                              v-model="data.buy_small_color"></el-input>
                                </div>
                            </el-form-item>
                            <el-form-item label="按钮颜色" prop="buy_btn_bg_color">
                                <el-color-picker class="diy-color-picker" size="small"
                                                 v-model="data.buy_btn_bg_color"></el-color-picker>
                                <el-input size="small" style="width: 80px;margin-right: 25px;"
                                          v-model="data.buy_btn_bg_color"></el-input>
                            </el-form-item>
                            <el-form-item label="按钮文字" prop="buy_btn_text">
                                <div flex="dir:left cross:center">
                                    ...
                                    <el-color-picker class="diy-color-picker" size="small"
                                                     v-model="data.buy_btn_color"></el-color-picker>
                                    <el-input size="small" style="width: 80px;margin-right: 25px;"
                                              v-model="data.buy_btn_color"></el-input>
                                </div>
                            </el-form-item>
                        </el-form-item>
                    </el-form>
                        ...
                        <el-form-item class="diy-user-label" label="已购买用户" prop="renew_user">
                            <el-form-item label="背景图" prop="renew_bg">
                                <div style="position: relative">
                                    ...
                                    <div style="margin: 10px 0;position: relative;width: 80px;">
                                        ...
                                        <el-button v-if="renew_bg != ''" class="diy-del-btn"
                                                   @click="resetImg(1,'renew')" size="mini" type="danger"
                                                   icon="el-icon-close" circle></el-button>
                                    </div>
                                    <el-button size="mini" @click="resetImg(2,'renew')" class="diy-reset"
                                               type="primary">恢复默认
                                    </el-button>
                                </div>
                            </el-form-item>
                            <el-form-item label="文字" prop="renew_text">
                                <div flex="dir:left cross:center">
                                    ...
                                    <el-color-picker class="diy-color-picker" size="small"
                                                     v-model="data.renew_text_color"></el-color-picker>
                                    <el-input size="small" style="width: 80px;margin-right: 25px;"
                                              v-model="data.renew_text_color"></el-input>
                                </div>
                            </el-form-item>
                            <el-form-item label="按钮颜色" prop="renew_btn_bg_color">
                                <el-color-picker class="diy-color-picker" size="small"
                                                 v-model="data.renew_btn_bg_color"></el-color-picker>
                                <el-input size="small" style="width: 80px;margin-right: 25px;"
                                          v-model="data.renew_btn_bg_color"></el-input>
                            </el-form-item>
                        </el-form-item>
                    </el-form>
                </template>
                <app-padding @ss="setStyle" v-model="data">
                    <template slot="bg">
                        <el-form-item label="底部背景颜色">
                            <el-color-picker @change="(row) => {row == null ? value.background = '#ffffff' : ''}"
                                             size="small"
                                             v-model="value.background"></el-color-picker>
                            <el-input size="small" class="c-input-big"
                                      v-model="value.background"></el-input>
                        </el-form-item>
                    </template>
                    <template slot="c-bg">
                        <span></span>
    ...
    Vue.component('diy-vip-card', {
        ...
        data() {
            ...
            return {
                ...
                default: {
                    background: '#FFFFFF',
                    buy_bg: host + 'statics/img/app/vip_card/buy_bg_two.png',
                    renew_bg: host + 'statics/img/app/vip_card/buy_bg_two.png',
        ...
        methods: {
            ...
            reset() {
                ...
                if (that.usePluginConfig) {
                    ...
                    that.data.usePluginConfig = that.usePluginConfig;
                    that.buy_bg = host + 'statics/img/app/vip_card/buy_bg_two.png';
                    that.renew_bg = host + 'statics/img/app/vip_card/buy_bg_two.png';
                    that.data.background = that.background;
                    that.data.top_bottom_padding = that.top_bottom_padding;
                    that.data.background = that.background;
                    that.data.top_bottom_padding = that.top_bottom_padding;
            ...
            resetImg(res, position) {
                ...
                switch (position) {
                    case 'buy':
                        if (res == 2) {
                            this.buy_bg = host + 'statics/img/app/vip_card/buy_bg_two.png';
                            this.data.buy_bg = host + 'statics/img/app/vip_card/buy_bg_two.png';
                        } else {
                            this.buy_bg = '';
                            this.data.buy_bg = '';
                        }
                    ...
                    case 'renew':
                        if (res == 2) {
                            this.renew_bg = host + 'statics/img/app/vip_card/buy_bg_two.png';
                            this.data.renew_bg = host + 'statics/img/app/vip_card/buy_bg_two.png';
                        } else {
                            this.renew_bg = '';
                            this.data.renew_bg = '';
                        }
