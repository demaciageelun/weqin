        ...
        <div class="diy-component-edit">
            <el-form label-width="100px">
                ...
                <el-form-item label="颜色设置">
                    <app-radio v-model="data.bgType" label="color">颜色</app-radio>
                    <app-radio v-model="data.bgType" label="pic">背景图</app-radio>
                </el-form-item>
                <el-form-item label="背景颜色" v-if="data.bgType === 'color'">
                ...
                <el-form-item label="背景图" v-if="data.bgType === 'pic'" prop="backgroundPicUrl">
                ...
                <el-form-item label="导航图标">
                    <draggable class="goods-list" style="width: 355px;max-height: 600px;overflow-y: auto;padding-right: 25px;" flex="dir:top" v-model="data.navs"
                ...
                handler(newVal, oldVal) {
                    ...
                    setTimeout(() => {
                        ...
                        this.$nextTick(()=>{ // 页面渲染完成后的回调
                            this.refContent = `建议尺寸:750 * ${refHeight.offsetHeight}`;
                        })
                    })
                },
            },
