 ...
 * @property int $is_refund 0.默认未处理.已退款2.待退款
 */
class PintuanOrderRelation extends \app\models\ModelActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['order_id', 'pintuan_order_id', 'is_parent', 'is_delete', 'user_id', 'is_groups', 'robot_id', 'cancel_status', 'is_refund'], 'integer'],
            [['created_at'], 'safe'],
        ];
    }
