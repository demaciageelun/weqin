...
class LotteryDetailForm extends Model
{
    ...
    private function getLog($id)
    {
        ...
        return [$list, $all_num, CommonLottery::flashUserInfoAll($user_list, true)];
    }
    ...
    public function goods()
    {
        ...
        try {
            ...
            $newGoods = [
                ...
                'keyword' => $lottery['goods']['goodsWarehouse']['keyword'],
                'num' => $num,
            ...
            return [
                ...
                'data' => [
                    'goods' => $newGoods,
                    'lottery' => $lottery,
                    'lucky_list' => CommonLottery::flashUserInfoAll($lucky_list, true),
                    'user_log' => $user_log,
