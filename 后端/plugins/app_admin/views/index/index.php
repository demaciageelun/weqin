    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <div class="input-item">
                <el-input @keyup.enter.native="search" size="small" placeholder="请输入ID/昵称/手机号/备注/联系方式" v-model="keyword" clearable @clear="search">
                            ...
                            <div flex="dir:left cross:center">
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div flex="main:justify" style="width: 100%;">
                                        ...
                                        <el-button v-if="scope.row.platform_user_id" @click="openId(scope.$index)" type="success" style="float:right;padding:5px !important;">显示OpenId</el-button>
                                    </div>
                                </div>
                            </div>
