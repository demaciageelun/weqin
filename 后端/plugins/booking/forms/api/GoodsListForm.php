    ...
    public function search()
    {
        ...
        foreach ($list as $k => $goods) {
            ...
            $newList[$k] = [
                ...
                'price_content' => $goods['price'] > 0 ? "￥" . $goods['price'] : '免费预约',
                ...
                'level_show' => $setting['is_member_price'] ? $goods['is_level'] : 0,
                'video_url' => $this->keyword ? '' : Video::getUrl($goods['goodsWarehouse']['video_url']),
                ...
                'page_url' => '/plugins/book/goods/goods?goods_id=' . $goods['id']
            ];
        }
