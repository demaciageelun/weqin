 ...
 * @property int $is_coupon 是否优惠券;
 * @protected int $is_integral 是否积分抵扣;
 */
class StepSetting extends ModelActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['mall_id', 'convert_max', 'convert_ratio', 'invite_ratio', 'ranking_num', 'is_share', 'is_sms', 'is_mail', 'is_print', 'is_territorial_limitation',
                'is_coupon', 'is_integral'], 'integer'],
