    ...
    <el-dialog :title="title" :visible.sync="add" width="30%">
        <el-form :model="form" label-width="100px" style="width: 90%">
            <el-form-item label="活动名称">
                <el-input size="small" v-model="form.title" autocomplete="off" maxlength="50"></el-input>
            </el-form-item>
            ...
            <el-form-item label="挑战步数">
                <el-input size="small" v-model="form.step_num" autocomplete="off"
                          oninput="this.value = this.value.match(/[1-9][0-9]{0,6}/)"></el-input>
            </el-form-item>
            <el-form-item label="缴纳金">
                <el-input size="small" v-model="form.bail_currency" autocomplete="off"
                          oninput="this.value = this.value.match(/^\d{0,6}((\.)\d{0,2})?/g)"
                >
