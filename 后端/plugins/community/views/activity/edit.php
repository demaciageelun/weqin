        ...
        <el-dialog title="编辑库存" :visible.sync="stockVisible" :before-close="stockClose">
            <div class="set-inventory">
                <div class="input" flex="main:center cross:center">
                    ...
                    <div>
                        <el-input size="small" oninput="this.value = this.value.replace(/[^0-9]/g, '');" :min="0" type="number" v-model="stock" @change="setStock">
            ...
            <el-table
                ...
                <el-table-column
                        ...
                        label="库存">
                    <template slot-scope="scope" oninput="this.value = this.value.replace(/[^0-9]/g, '');" :min="0" type="number">
