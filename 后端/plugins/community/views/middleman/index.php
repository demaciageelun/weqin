...
<div id="app" v-cloak>
    ...
    <el-dialog title="编辑团长信息" :visible.sync="editDialog" width="670px">
        ...
        <el-form :model="user" size="small" :rules="rules" ref="user" label-width="90px">
            ...
            <el-form-item label="提货地址" prop="detail">
                <el-input v-model="user.detail"></el-input>
            </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
            <el-button size="small" @click="editDialog = false">取 消</el-button>
            <el-button size="small" type="primary" @click="beEdit('user')" :loading="contentBtnLoading">确定修改</el-button>
        </div>
    </el-dialog>
</div>
<script>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    mobile: [
                        {required: true, message: '请输入团长手机号', trigger: 'blur'},
                    ],
                    detail: [
                        {required: true, message: '请输入团长提货地址', trigger: 'blur'},
                    ],
                },
                activeName: '-2',
            }
