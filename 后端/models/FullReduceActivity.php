 ...
 * @property string $app_share_title 分享标题
 * @property string $app_share_pic 分享图片
 */
class FullReduceActivity extends \app\models\ModelActiveRecord
{
    ...
    {
        return [
            [['mall_id', 'name', 'created_at', 'updated_at', 'deleted_at', 'start_at', 'end_at', 'appoint_type',
                'rule_type', 'appoint_goods', 'noappoint_goods'], 'required'],
            [['mall_id', 'status', 'appoint_type', 'rule_type', 'is_delete'], 'integer'],
            [['created_at', 'updated_at', 'deleted_at', 'start_at', 'end_at'], 'safe'],
            [['appoint_goods', 'noappoint_goods', 'app_share_pic'], 'string'],
            [['name', 'app_share_title'], 'string', 'max' => 255],
