            ...
            <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
                ...
                <el-card shadow="never">
                    ...
                    <div>
                        ...
                        <el-form-item label="打印纸高度" prop="kd100_t_height">
                            <template slot='label'>
                                <span>打印纸高度</span>
                                <el-tooltip effect="dark" content="打印纸的高度，以mm为单位，请按照面单模板尺寸传入"
                                            placement="top">
                                    <i class="el-icon-info"></i>
                                </el-tooltip>
                            </template>
                        ...
                        <el-form-item label="打印纸宽度" prop="kd100_t_width">
                            <template slot='label'>
                                <span>打印纸宽度</span>
                                <el-tooltip effect="dark" content="打印纸的宽度，以mm为单位，请按照面单模板尺寸传入"
                                            placement="top">
                                    <i class="el-icon-info"></i>
                                </el-tooltip>
                            </template>
