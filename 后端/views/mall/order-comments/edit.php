        ...
        <div slot="header" class="clearfix">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer"
                                          @click="$navigate({r:'mall/order-comments/index'})">评价管理</span>
                </el-breadcrumb-item>
        ...
        <div class="form-body">
            <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
                ...
                <el-form-item label="评价时间" prop="virtual_time">
                    <el-date-picker style="width: 100%" size="small" v-model="form.virtual_time" type="datetime"
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            picUrl(e) {
                if (e.length) {
                    let self = this;
                    self.form.pic_url = self.form.pic_url || [];
