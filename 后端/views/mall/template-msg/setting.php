        ...
        <div class="text item">
            <el-form :model="form" label-width="210px" :rules="FormRules" ref="form">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="管理员使用" name="first">
<!--                         <el-card shadow="never" style="margin-top: 12px;">
                        ...
                        <el-card shadow="never" style="margin-top: 12px;position: relative">
                            <div slot="header">
                                <span>模板消息ID配置</span>
                            </div>
                     ...
                     <el-tab-pane label="用户使用" name="two" v-if="form.show_user == 1">
                         <el-card shadow="never" style="margin-top: 12px;">
                             <el-row>
                                 <div class="title">温馨提示：获取前请先确认您已获得模板消息的使用权限，并且模板消息中没有任何数据。获取后请不要到公众号后台 删除相应的模板消息，否则会影响模板消息正常使用。</div>
                                 <el-form-item style="margin: 10px 0">
                                     <el-button type="primary" size="mini" @click="getUserTemplate">一键添加模板消息</el-button>
                                     <el-button type="primary" size="mini" @click="testQrcode">生成测试二维码</el-button>
                                 </el-form-item>
                                 <el-form-item v-for="(item, index) in form.user_template" :label="item.name">
                                     <el-input size="small" class="mp-input" v-model="item[item.tpl_name]" placeholder="请输入模板Id" autocomplete="off"></el-input>
                                 </el-form-item>
                             </el-row>
                         </el-card>
                     </el-tab-pane>
        ...
        <el-dialog title="测试二维码" :visible.sync="templateVisible">
            <div style="text-align: center">
                <div style="margin-bottom: 10px">温馨提示：请先保存好二维码之后在进行测试！</div>
                <div v-if="qrcode">
