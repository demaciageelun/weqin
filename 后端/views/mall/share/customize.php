                                    ...
                                    <div class="content-block head-block">
                                        <div flex="dir:left cross:center" style="padding-bottom:10px;border-bottom:1px solid #FFFFFF">
                                            ...
                                            <div style="margin-left: 20px;color: #fff;">
                                                <div>用户昵称</div>
                                                <div style="margin-top:10px">{{words.parent_name.name}}：{{words.head_office.name}}</div>
                                            </div>
                                        </div>
                            ...
                            <div class='form-body'>
                                <el-form :model="form" label-width="50px">
                                    <el-form-item prop="level">
                                        ...
                                        <div v-if="words.head_office" flex="dir:left cross:center" class="share-text">
                                            <div class="default">{{words.head_office.default}}</div>
                                            <app-image width="12px" height="12px" mode="aspectFill" :src="customize_pic"></app-image>
                                            <el-input class="text-input" v-model="words.head_office.name"></el-input>
                                        </div>
                                    </el-form-item>
                                </el-form>
                            </div>
