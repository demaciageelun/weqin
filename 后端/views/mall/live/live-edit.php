    ...
    <el-card class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="130px">
                ...
                <el-form-item label="频道封面图" prop="feedsImg" >
                    <app-attachment :multiple="false" :max="1" v-model="ruleForm.feedsImg">
                        <el-tooltip effect="dark" content="建议像素800*800,大小不超过100KB" placement="top">
                            <el-button style="margin-bottom: 10px;" size="mini">选择图片</el-button>
                        </el-tooltip>
                    </app-attachment>
                    <app-gallery :url="ruleForm.feedsImg" :show-delete="true" @deleted="ruleForm.feedsImg = ''"
                                 width="80px" height="80px">
                    </app-gallery>
                </el-form-item>
            </el-form>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    cover_img: [
                        {required: true, message: '请选择直播背景图', trigger: 'change'},
                    ],
                    share_img: [
                        {required: true, message: '请选择直播分享图', trigger: 'change'},
                    ],
                    feedsImg: [
                        {required: true, message: '请选择频道封面图', trigger: 'change'},
                    ],
                },
                btnLoading: false,
                cardLoading: false,
