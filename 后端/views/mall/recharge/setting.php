            ...
            <el-form :model="form" v-loading="loading" label-width="10rem" ref="form">
                ...
                <el-form-item label="背景图片" prop="bj_pic_url" size="small">
                    <app-attachment @selected="bjSelected">
                        ...
                        <el-button size="mini" @click.stop="resetImg('bj')" class="reset" type="primary">恢复默认</el-button>
                    </app-attachment>
                    <app-gallery style="margin-top: 10px;" v-if="form.bj_pic_url.url" :url="form.bj_pic_url.url" width="80px" height="80px" :show-delete="true" @deleted="delPic('bj')"></app-gallery>
                    <app-image style="margin-top: 10px;margin-bottom: 10px" v-else mode="aspectFill" :src="form.bj_pic_url.url" width="80" height="80"></app-image>
                </el-form-item>
                </el-form-item>
                <el-form-item label="广告图片" prop="ad_pic_url" size="small">
                    <app-attachment @selected="adSelected">
                        ...
                        <el-button size="mini" @click.stop="resetImg('ad')" class="reset" type="primary">恢复默认</el-button>
                    </app-attachment>
                    <app-gallery style="margin-top: 10px;" v-if="form.ad_pic_url.url" :url="form.ad_pic_url.url" width="80px" height="80px" :show-delete="true" @deleted="delPic('ad')"></app-gallery>
                    <app-image style="margin-top: 10px;margin-bottom: 10px" v-else mode="aspectFill" :src="form.ad_pic_url.url" width="80" height="80"></app-image>
                </el-form-item>
                </el-form-item>
                ...
                <el-form-item label="充值说明图标" prop="re_pic_url" size="small">
                    <app-attachment @selected="iconSelected">
                        ...
                        <el-button size="mini" @click.stop="resetImg('re')" class="reset" type="primary">恢复默认</el-button>
                    </app-attachment>
                    <app-gallery style="margin-top: 10px;" v-if="form.re_pic_url.url" :url="form.re_pic_url.url" width="80px" height="80px" :show-delete="true" @deleted="delPic('re')"></app-gallery>
                    <app-image style="margin-top: 10px;margin-bottom: 10px" v-else mode="aspectFill" :src="form.re_pic_url.url" width="80" height="80"></app-image>
                </el-form-item>
                </el-form-item>
...
<script>
    const app = new Vue({
        ...
        methods: {
            resetImg(obj) {
                if(obj == 'bj') {
                    this.form.bj_pic_url.url = this.form.bj_pic_defalut
                }
                if(obj == 'ad') {
                    this.form.ad_pic_url.url = this.form.ad_pic_defalut
                }
                if(obj == 're') {
                    this.form.re_pic_url.url = this.form.re_pic_defalut
                }
            },
            delPic(obj) {
                if(obj == 'bj') {
                    this.form.bj_pic_url.url = ''
                }
                if(obj == 'ad') {
                    this.form.ad_pic_url.url = ''
                }
                if(obj == 're') {
                    this.form.re_pic_url.url = ''
                }
            },
            bjSelected(list) {
