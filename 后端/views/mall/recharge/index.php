...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <span>充值管理</span>
            <el-button style="float: right; margin: -5px 0px" type="primary" size="small"
        ...
        <div class="table-body">
            ...
            <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
                ...
                <el-table-column prop="name" label="充值名称" width="200"></el-table-column>
                <el-table-column prop="pay_price" label="支付金额(元)" width="150">
                </el-table-column>
                <el-table-column prop="send_info" label="赠送信息">
                    <template slot-scope="scope">
                        <div v-if="scope.row.send_type & 0b00000001" style="margin: 5px 0">
                            赠送的金额：{{scope.row.send_price}}元
                        </div>
                        <div v-if="scope.row.send_type & 0b00000010" style="margin: 5px 0">
                            赠送的积分：{{scope.row.send_integral}}
                        </div>
                        <div style="margin: 5px 0" v-if="scope.row.send_type & 0b00000100 && scope.row.member">
                            赠送的会员：{{scope.row.member.name}}
                        </div>
                        ...
                        <div v-if="scope.row.send_type & 0b00100000 && is_plugin_show">
                            抽奖次数：{{scope.row.lottery_limit}}次
                        </div>
                    </template>
                </el-table-column>
