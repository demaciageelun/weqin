...
<div id="app" v-cloak>
    ...
    <el-card shadow="never" class="el-card" v-loading="loading" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <el-form size="small"  label-width="160px" :model="form" :rules="rules" >
            ...
            <div class="table-body">
                ...
                <div class="table-item">
                    <el-form-item prop="app_share_title" class="name">
                        <label slot="label">
                            <span>自定义分享标题</span>
                        ...
                        <div >
                           <el-form-item>
                               ...
                               <div class="flight-item" v-if="form.rule_type === 1" v-for="(item, index) in form.discount_rule">
                                   ...
                                   <div class="item-body">
                                       <el-form-item label="优惠门槛" required label-width="110px">
                                       ...
                                       <el-form-item label="优惠内容" required label-width="110px">
                                           <div style="width: 100%" flex="main:left">
