    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 0;">
        <div class="table-body">
            <div>
                ...
                <el-button size="small" type="primary" @click="edit">新建权限套餐</el-button>
            </div>
            <el-table
                ...
                <el-table-column
                    prop="permissions_text"
                    width="300"
                    label="插件">
                    <template slot-scope="scope">
                        <app-ellipsis :line="1">{{scope.row.permissions_text}}</app-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        prop="created_at"
        ...
        methods: {
            ...
            destroy(id) {
                ...
                self.$confirm('删除该条数据, 是否继续?', '提示', {
                    ...
                    request({
                        params: {
                            r: 'admin/user/permissions-group-destroy',
                        },
                        method: 'post',
                        data: {
                            id: id,
