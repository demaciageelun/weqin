...
$string = '';
if(strpos($hostInfo,'http://') !== false){ 
    $string = 'http://';
}

if(strpos($hostInfo,'https://') !== false){ 
    $string = 'https://';
}

$hostInfo = str_replace($string, '', $hostInfo);

$license = License::find()->andWhere(['domain' => $hostInfo, 'is_delete' => 0])->asArray()->one();
        ...
        <div class="opacity" flex="cross:center main:center">
            ...
            <div class="foot" :style="{'bottom': footHeight}">
                ...
                <template v-if="license">
                    <a style="text-decoration: none" target="_blank" :href="license.icp_link"><span>| 备案号：{{license.icp_number}}</span></a>
                    <!-- 备案号 -->
                    <div flex="main:center">
                        <img style="width: 22px;height: 22px;margin-right: 5px;" :src="_baseUrl + '/statics/img/admin/security.png'">
                        <span>{{license.security_address}}{{license.security_number}}号</span>
