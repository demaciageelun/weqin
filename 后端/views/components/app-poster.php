            ...
            <div class="poster-mobile-box" flex="dir:top">
                <div class="poster-bg-box">
                    ...
                    <el-image v-if="rule_form.qr_code && rule_form.qr_code.is_show == 1"
                              ...
                              :style="{
                                         position: 'absolute',
                                         borderRadius: rule_form.qr_code.type == 1 ? '50%': '0',
                    ...
                    <span v-if="rule_form.remake && rule_form.remake.is_show == 1"
                          v-html="rule_form.remake.text"
                          :style="{
                                                    width: rule_form.remake.width + 'px',
                                                    wordWrap: 'break-word',
                                                    wordBreak: 'normal',
                                                    position: 'absolute',
                                                    top: rule_form.remake.top + 'px',
                                                    left: rule_form.remake.left + 'px',
                                                    fontSize: rule_form.remake.font * 2 + 'px',
                                                    color: rule_form.remake.color}">
                    </span>
            ...
            <div class="poster-form-body" flex="dir:top">
                ...
                <el-card shadow="never" class="box-card" style="width: 100%;">
                    ...
                    <div>
                        ...
                        <template v-else-if="goods_component_key == 'remake'">
                            <el-form-item label="文本内容">
                                <el-input v-model="rule_form.remake.text"></el-input>
                            </el-form-item>
                            <el-form-item label="大小">
                                <el-slider
                                        :min=12
                                        :max=30
                                        v-model="rule_form.remake.font"
                                        show-input>
                                </el-slider>
                            </el-form-item>
                            <el-form-item label="文本宽度" v-if="rule_form.remake.width">
                                <el-slider
                                        :min=1
                                        :max=750
                                        v-model="rule_form.remake.width"
                                        show-input>
                                </el-slider>
                            </el-form-item>
                            <el-form-item label="上间距">
                                <el-slider
                                        :min=0
                                        :max=1334-(rule_form.remake.font)
                                        v-model="rule_form.remake.top"
                                        show-input>
                                </el-slider>
                            </el-form-item>
                            <el-form-item label="左间距">
                                <el-slider
                                        :min=0
                                        :max=750-(rule_form.remake.font)
                                        v-model="rule_form.remake.left"
                                        show-input>
                                </el-slider>
                            </el-form-item>
                            <el-form-item label="颜色">
                                <el-color-picker
                                        style="margin-left: 20px;"
                                        color-format="rgb"
                                        v-model="rule_form.remake.color"
                                        :predefine="predefineColors">
                                </el-color-picker>
                            </el-form-item>
                        </template>
