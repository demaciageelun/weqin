                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    <template v-if="is_info == 1 || sign === 'exchange'">
                                        ...
                                        <!-- 关键词 -->
                                        <el-form-item label="关键词" v-if="is_name === 1" prop="keyword" class="title-input"
                                        >
                                        ...
                                        <el-form-item label="关键词" class="title-input" v-else>
                                            <el-input v-model="ruleForm.keyword"
                                                      placeholder="商品关键词能准确搜到商品的，如：华为手机/手机之类"
                                                      maxlength="100"
                                                      disabled
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <template v-if="is_attr == 1">
                                        ...
                                        <!-- 商品条形码 -->
                                        <el-form-item v-if="is_mch !== 1" label="条形码">
                                            <el-input :disabled="ruleForm.use_attr == 1 || (sign !== 'mall') ? true : false"
                                                      placeholder="请输入条形码"
