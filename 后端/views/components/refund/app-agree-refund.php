    ...
    Vue.component('app-agree-refund', {
        ...
        methods: {
            ...
            openDialog(e) {
                ...
                } else if (this.refundOrder.order.send_type == 1 || this.refundOrder.order.send_type == 2 || this.refundOrder.order.send_type == 3) {
            ...
            agreeCityRefund(orderRefund) {
                let text = orderRefund.order.send_type == 2 ? '该订单为同城配送订单，需商家上门收货' : '该订单为到店自提订单，需买家送货到相应门店'
