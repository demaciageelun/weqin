<style>
    .app-select-member .input-item {
        display: inline-block;
        width: 250px;
    }

    .app-select-member .input-item .el-input__inner {
        border-right: 0;
        border-color: #DCDFE6;
    }

    .app-select-member .input-item .el-input__inner:hover {
        border: 1px solid #dcdfe6;
        border-right: 0;
        outline: 0;
    }

    .app-select-member .input-item .el-input__inner:focus {
        border: 1px solid #dcdfe6;
        border-right: 0;
        outline: 0;
    }

    .app-select-member .input-item .el-input-group__append {
    ...
    .app-select-member .input-item .el-input-group__append .el-button {
        padding: 0;
    }
    ...
    Vue.component('app-select-member', {
        ...
        data() {
            return {
                ...
                form: {
                    member_id: JSON.parse(JSON.stringify(this.value)),
                },
                memberList: null,
                memberDialog: false,
                page: 1,
