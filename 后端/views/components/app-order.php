                    ...
                    <div>
                        <div style="box-sizing:border-box;width: 100%;display: flex;border-bottom:1px solid #000000;position: relative;left: -0.5px;"
                            ...
                            <div :style="tableWidth" style="display: flex;" v-if="printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.unitPrice">
                               ...
                               >商品名称</div>
                                <div :style="
                                     {
                                         width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '25%' : !printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice  ? '25%' : printPar.goodsInf.name && printPar.goodsInf.attr && !printPar.goodsInf.unitPrice ? '25%' : '100%'
                                         }"
                                       style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;box-sizing:border-box;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;flex-shrink: 0" v-if="printPar.goodsInf.attr">规格</div>
                            ...
                            <div style="box-sizing:border-box;width: 12%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;flex-shrink: 0"
                                 v-if="printPar.goodsInf.univalent">小计
                            </div>
                            <div style="box-sizing:border-box;width: 18%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;flex-shrink: 0"
                                 v-if="printPar.goodsInf.article_number">货号
                            </div>

                            <div style="box-sizing:border-box;width: 8%;height: 30px;border-left: 1px solid #000000;line-height: 30px;padding-left: 0.5%;font-size:10px;flex-shrink: 0"
                        ...
                        <div v-for="good in item.detail"
                            ...
                            <div :style="tableWidth" style="display: flex;" v-if="printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.unitPrice">
                               <div
                                       :style="{width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : printPar.goodsInf.name && (!printPar.goodsInf.attr || !printPar.goodsInf.unitPrice) ? '75%' :'100%'}"
                                       style="min-width: 0;flex-grow: 1; word-break: break-all;flex-shrink: 1;-webkit-box-flex: 1;word-wrap:break-word;box-sizing:border-box;word-wrap: break-word;border-left: 1px solid #000000;padding:  10px 10px 10px 0.5%;font-size:10px;position: relative;flex-shrink: 0"  v-if="printPar.goodsInf.name">
                                   {{good.name}}
                               </div>
                               <div
                                       :style="
                                     {
                                       ...
                                       style="min-width: 0;flex-grow: 1; word-break: break-all;flex-shrink: 1;-webkit-box-flex: 1;word-wrap:break-word;box-sizing:border-box;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative;flex-shrink: 0" v-if="printPar.goodsInf.attr">
                                   {{good.attr}}
                               </div>
                                <div style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;width: 60%;border-left: 1px solid #000000;box-sizing:border-box;padding:  10px 10px 10px 0.5%;font-size:10px;flex-shrink: 0"
                                     :style="{width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '25%' : !printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : printPar.goodsInf.name && !printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : '100%'}"
                                     v-if="printPar.goodsInf.unitPrice"
                                >{{good.unit_price}}
                                </div>
                           </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 8%;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative;flex-shrink: 0"
                                 v-if="printPar.goodsInf.number">
                                {{good.num}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 12%;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px .5%;position: relative;flex-shrink: 0"
                                 v-if="printPar.goodsInf.univalent">
                                ￥{{good.price}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 18%;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px .5%;position: relative;flex-shrink: 0"
                                 v-if="printPar.goodsInf.article_number">
                                {{good.goods_no}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 8%;border-left: 1px solid #000000;word-wrap: break-word;font-size:10px;padding: 10px 10px 10px .5%;position: relative;flex-shrink: 0"
